      ...
      <div className="max-w-5xl mx-auto">
        ...
        <form className="space-y-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  type="button"
                  className="px-3 py-1 border border-dashed border-slate-300 text-slate-400 text-[11px] font-bold rounded-full hover:bg-slate-50 transition"
                >
                  + Add Skill
                </button>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="border-2 border-dashed border-slate-200 rounded-2xl p-8 flex flex-col items-center justify-center text-center hover:bg-slate-50 transition cursor-pointer group">
                ...
                <div className="mt-4 w-full bg-white border border-slate-100 rounded-lg p-2 flex items-center justify-between shadow-sm">
                  ...
                  <button className="text-rose-500 text-xs font-bold px-1 hover:bg-rose-50 rounded">
                    ✕
                  </button>
                </div>
              </div>
          ...
          <div className="flex flex-col items-center gap-6 pt-6">
            ...
            <button
              type="submit"
              className="w-full md:w-auto px-16 py-4 bg-slate-900 text-white font-bold rounded-xl hover:bg-slate-800 transition-all flex items-center justify-center gap-3 shadow-xl shadow-slate-200"
            >
