...
const ProfileField = ({ label, value, isError, isMuted }: ProfileFieldProps) => (
...
const SelectionBox = ({ label, value, active, isItalic }: SelectionBoxProps) => (
  <div
...
const TaskRow = ({ name, match }: TaskRowProps) => (
    ...
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-[10px] text-slate-400 font-medium">
          Match Confidence: <span className="text-blue-500">{match}</span> • Shared Phone
        </p>
      </div>
    </div>
...
const FiUser = ({ className }: FiUserProps) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
