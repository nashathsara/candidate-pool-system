...
const MatchBadge = ({ icon, label, value }: MatchBadgeProps) => (
...
const HistoryItem = ({ icon, title, time }: HistoryItemProps) => (
    ...
    <div className="min-h-screen bg-[#F8FAFC] p-8 font-sans text-slate-900">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div className="mt-8 p-10 bg-[#4ADE80] flex justify-center gap-6">
          <button className="px-8 py-2.5 bg-slate-900 text-white text-xs font-bold rounded-lg hover:bg-slate-800 transition">
            Merge Profiles
          </button>
          <button className="px-8 py-2.5 bg-slate-900/10 text-slate-900 text-xs font-bold rounded-lg hover:bg-slate-900/20 transition">
            Request Info
          </button>
          <button className="px-8 py-2.5 bg-slate-900/10 text-slate-900 text-xs font-bold rounded-lg hover:bg-slate-900/20 transition">
            Keep Separate
